...
"" "" "" \
" enter" "Kitty Terminal" "(kitty)" \
" SHIFT enter" "DropDown Kitty Terminal" " Q to close" \
...
" Print" "full window screenshot" "(snappy)" \
"Print" "screenshot region" "(snappy)" \
"CTRL ALT P" "power-menu" "(wlogout)" \
" X" "screen lock" "(hyprlock)" \
