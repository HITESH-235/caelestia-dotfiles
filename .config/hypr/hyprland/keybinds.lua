...
for _, dir in ipairs({ "left", "right", "up", "down" }) do
    ...
    create_bind("SUPER + ALT + " .. dir, hl.dsp.window.move({ direction = dir }))
end
...
create_bind("SUPER + SHIFT + I", hl.dsp.layout("togglesplit"))

-- Custom overrides added
create_bind("SUPER + I", hl.dsp.global("caelestia:sidebar"))
create_bind("Print", hl.dsp.exec_cmd("/home/hit235/.config/hypr/scripts/ScreenShot.sh --swappy"))
create_bind("SUPER + Print", hl.dsp.exec_cmd("/home/hit235/.config/hypr/scripts/ScreenShot.sh --swappy-now"))
